...
struct FileReader {
    ...
    public:
        ...
        using value_type = LineReader;
        using difference_type = std::ptrdiff_t;
        using pointer = const value_type*;
        using reference = value_type;

        iterator(FileReader* reader = nullptr) : m_reader(reader) {}
...
struct StringToIdMap {
  ...
  private:
    ...
    std::unordered_map<int, std::string> bwd;
};
